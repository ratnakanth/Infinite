...
define([
    'jquery',
    'Antiquity_Infinite/js/http_build_query',
    'uiRegistry',
    'underscore',
    'mage/cookies',
    ...
    $.widget('mage.atqScrollScript', {
        ...
        classes: {
            loadButton: 'atqscroll-load-button',
            loadingBlock: 'atqscroll-loading-block',
            loadingIcon: 'atqscroll-loading-icon',
            loading: '-atqscroll-loading',
            svgPathToFill: 'atqscroll-fill-path',
            backToTopButton: 'atqscroll-backtotop-block',
            backToTopEnabled: '-atqscroll-backtotop-enabled',
            active: '-atqscroll-active',
            text: 'atqscroll-text',
            animate: '-atqscroll-animate',
            pageNumber: 'atqscroll-page-num'
        },
        pageSelector: '[atqscroll-page="%1"]',
        lastPageSelector: '.atqscroll-page:last, .atqscroll-pages:last',
        ...
        _create: function (options) {
            ...
            $(document).on("atqscroll_refresh", function () {
                self.initialize(); //run jQuery(document).trigger('atqscroll_refresh');
            });
        ...
        handleUnexpectedResponse: function (response) {
            console.warn('Antiquity_Infinite: invalid response from server.', {response: response});
            this._stop();
        },
        ...
        _preloadPages: function () {
            ...
            productContainer.attr('atqscroll-page', this.currentPage);
            productContainer.addClass('atqscroll-page');
        ...
        _updateUrlAndCurrentPage: function () {
            ...
            $(self.options['product_container']).each(function (index) {
                if (self._mostlyVisible(this, index)) {
                    var page = parseInt($(this).attr('atqscroll-page'));
        ...
        _createLoading: function (position) {
            var elementSelector = '.' + this.classes.loadingBlock,
                ...
                lastSelector = '.atqscroll-page:last ~ ' + elementSelector,
                loadingElement = $('<div/>', {
        ...
        _generateButton: function (position) {
            ...
            $('.' + this.classes.loadButton + '[atqscroll_type="' + position + '"]').on('click', function (item) {
        ...
        buttonClick: function (event) {
            var element = $(event.target),
                type = element.attr('atqscroll_type');
        ...
        _insertNewProductBlock: function (data, position) {
            ...
            productContainer.addClass('atqscroll-pages').attr('atqscroll-page', data.currentPage);
            ...
            if ('after' == position) {
                $('.atqscroll-page:last ~ .' + this.classes.loadButton).remove();
                $('.atqscroll-page:last ~ .' + this.classes.loadingBlock).remove();
            ...
            this._addObserverToProductLink($('.atqscroll-pages[atqscroll-page="' + data.currentPage + '"]'));
            if (this.type == 'button') {
        ...
        _addObserverToProductLink: function (productContainer) {
            ...
            productContainer.find('.item a').on("click", function (event) {
                try {
                    var parent = $(this).parents('.atqscroll-pages').first();
                    var page = parent ? parent.attr('atqscroll-page') : null;
                    if (page) {
                        var newUrl = self._generateUrl(page, 0);
                        if (!window.history.state || newUrl !== window.history.state.url) {
                            window.history.replaceState({url: newUrl}, '', newUrl);
        ...
        _generatePageTitle: function (page) {
            if ($('#atqscroll-page-num' + page).length) {
                return false;
            }

            pageNumEl = $('<div/>', {
                class: 'atqscroll-page-num -atqscroll-' + this.options['pageNumberStyle'],
                id: 'atqscroll-page-num' + page,
        ...
        initPageStepForwardListener: function (currentPage) {
            ...
            $('[atqscroll-page="' + currentPage + '"] .product-item').on('click touchstart', function (e) {
